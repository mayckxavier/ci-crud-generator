                ...
                <tr>
                    <td style="width: 550px">
                        ...
                        <?php echo form_dropdown('tipo_documento',
                            ...
                            $cliente->tipo_documento, 'name="tipo_documento" id="tipo_documento" class="roundedInput"
                            style="width: 200px"');
                            ?> <br><br/>

                            <label for="">Número do Documento:</label> <br/>
                            <input type="text" name="numero_documento" id="numero_documento" class="roundedInput cnpj"
                            style="width: 200px" value="<?php echo $cliente->numero_documento ?>"/><br/><br/>


                            <label for="">Telefone:</label> <br/>
                            <input type="text" name="telefone" class="roundedInput requiredInput" value="<?php echo $cliente->telefone ?>"/><br/><br/>


                            <label for="">Celular:</label> <br/>
                            <input type="text" name="celular" class="roundedInput requiredInput" value="<?php echo $cliente->celular ?>"/><br/><br/>

                            <label for="">Operadora:</label> <br/>
                            <input type="text" name="operadora" class="roundedInput requiredInput" value="<?php echo $cliente->operadora ?>"/><br/><br/>


                            <label for="">E-Mail:</label> <br/>
                            <input type="text" name="email" class="roundedInput requiredInput" value="<?php echo $cliente->email ?>"/><br/><br/>
